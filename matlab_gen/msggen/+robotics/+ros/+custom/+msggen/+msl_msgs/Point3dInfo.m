classdef Point3dInfo < robotics.ros.Message
    %Point3dInfo MATLAB implementation of msl_msgs/Point3dInfo
    ...
    properties (Constant)
        MessageType = 'msl_msgs/Point3dInfo' % The ROS message type
    end
    ...
    methods
        function obj = Point3dInfo(msg)
            %Point3dInfo Construct the message object Point3dInfo
        ...
        function set.X(obj, x)
            ...
            validateattributes(x, {'numeric'}, {'nonempty', 'scalar'}, 'Point3dInfo', 'X');
        ...
        function set.Y(obj, y)
            ...
            validateattributes(y, {'numeric'}, {'nonempty', 'scalar'}, 'Point3dInfo', 'Y');
        ...
        function set.Z(obj, z)
            ...
            validateattributes(z, {'numeric'}, {'nonempty', 'scalar'}, 'Point3dInfo', 'Z');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.msl_msgs.Point3dInfo.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.msl_msgs.Point3dInfo;
            obj.reload(strObj);
        end
    end
end
