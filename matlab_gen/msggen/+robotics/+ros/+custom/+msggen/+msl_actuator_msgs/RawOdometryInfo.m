classdef RawOdometryInfo < robotics.ros.Message
    %RawOdometryInfo MATLAB implementation of msl_actuator_msgs/RawOdometryInfo
    ...
    properties (Constant)
        MessageType = 'msl_actuator_msgs/RawOdometryInfo' % The ROS message type
    end
    ...
    methods
        function obj = RawOdometryInfo(msg)
            %RawOdometryInfo Construct the message object RawOdometryInfo
        ...
        function set.Position(obj, position)
            ...
            validateattributes(position, {obj.MslMsgsPositionInfoClass}, {'nonempty', 'scalar'}, 'RawOdometryInfo', 'Position');
        ...
        function set.Motion(obj, motion)
            ...
            validateattributes(motion, {obj.MslMsgsMotionInfoClass}, {'nonempty', 'scalar'}, 'RawOdometryInfo', 'Motion');
        ...
        function set.Timestamp(obj, timestamp)
            ...
            validateattributes(timestamp, {'numeric'}, {'nonempty', 'scalar'}, 'RawOdometryInfo', 'Timestamp');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.msl_actuator_msgs.RawOdometryInfo.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.msl_actuator_msgs.RawOdometryInfo;
            obj.reload(strObj);
        end
    end
end
