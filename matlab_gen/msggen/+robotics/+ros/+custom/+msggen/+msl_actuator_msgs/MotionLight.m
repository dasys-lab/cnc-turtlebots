classdef MotionLight < robotics.ros.Message
    %MotionLight MATLAB implementation of msl_actuator_msgs/MotionLight
    ...
    properties (Constant)
        MessageType = 'msl_actuator_msgs/MotionLight' % The ROS message type
    end
    ...
    methods
        function obj = MotionLight(msg)
            %MotionLight Construct the message object MotionLight
        ...
        function set.Enable(obj, enable)
            ...
            validateattributes(enable, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'MotionLight', 'Enable');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.msl_actuator_msgs.MotionLight.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.msl_actuator_msgs.MotionLight;
            obj.reload(strObj);
        end
    end
end
