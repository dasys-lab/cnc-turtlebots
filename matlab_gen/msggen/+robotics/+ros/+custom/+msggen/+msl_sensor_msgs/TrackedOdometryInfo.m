classdef TrackedOdometryInfo < robotics.ros.Message
    %TrackedOdometryInfo MATLAB implementation of msl_sensor_msgs/TrackedOdometryInfo
    ...
    properties (Constant)
        MessageType = 'msl_sensor_msgs/TrackedOdometryInfo' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '1b544a235e25c3b1df84594366da01f5' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Certainty', 'Motion', 'Position', 'Timestamp'} % List of non-constant message properties
        ROSPropertyList = {'certainty', 'motion', 'position', 'timestamp'} % List of non-constant ROS message properties
    end
    
    methods
        function obj = TrackedOdometryInfo(msg)
            %TrackedOdometryInfo Construct the message object TrackedOdometryInfo
        ...
        function set.Position(obj, position)
            ...
            validateattributes(position, {obj.MslMsgsPositionInfoClass}, {'nonempty', 'scalar'}, 'TrackedOdometryInfo', 'Position');
        ...
        function set.Motion(obj, motion)
            ...
            validateattributes(motion, {obj.MslMsgsMotionInfoClass}, {'nonempty', 'scalar'}, 'TrackedOdometryInfo', 'Motion');
        ...
        function set.Timestamp(obj, timestamp)
            ...
            validateattributes(timestamp, {'numeric'}, {'nonempty', 'scalar'}, 'TrackedOdometryInfo', 'Timestamp');
        ...
        function set.Certainty(obj, certainty)
            ...
            validateattributes(certainty, {'numeric'}, {'nonempty', 'scalar'}, 'TrackedOdometryInfo', 'Certainty');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.msl_sensor_msgs.TrackedOdometryInfo.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.msl_sensor_msgs.TrackedOdometryInfo;
            obj.reload(strObj);
        end
    end
end
