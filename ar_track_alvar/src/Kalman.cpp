...
KalmanSensor::KalmanSensor(const KalmanSensor& k)
        : KalmanSensorCore(k)
{
    R = cvCloneMat(k.R);
...
KalmanSensor::KalmanSensor(int n, int _m)
        : KalmanSensorCore(n, _m)
{
...
KalmanSensorEkf::KalmanSensorEkf(const KalmanSensorEkf& k)
        : KalmanSensor(k)
{
...
KalmanSensorEkf::KalmanSensorEkf(int _n, int _m)
        : KalmanSensor(_n, _m)
{
