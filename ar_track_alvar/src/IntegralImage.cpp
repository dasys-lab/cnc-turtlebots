...
*/
    double v = +((double*) sum->imageData)[y2 * sum->width + x2] - ((double*) sum->imageData)[y2 * sum->width + x1] -
               ((double*) sum->imageData)[y1 * sum->width + x2] + ((double*) sum->imageData)[y1 * sum->width + x1];
