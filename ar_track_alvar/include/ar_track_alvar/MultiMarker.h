...
public:
    ...
    */
     ...
     */
    bool PointCloudIsEmpty() { return pointcloud.empty(); }

    /** \brief Return the number of markers added using PointCloudAdd */
    size_t Size() { return marker_indices.size(); }
    ...
    std::vector<int> getIndices() { return marker_indices; }

    int getMasterId() { return master_id; }
