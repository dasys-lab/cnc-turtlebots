...
protected:
     ...
     */
    void _doEstimate(void** params, int param_c, void* model) { doEstimate((PARAMETER**) params, param_c, (MODEL*) model); }

    /**
     * Wrapper for templated parameters.
     */
    bool _doSupports(void* param, void* model) { return doSupports((PARAMETER*) param, (MODEL*) model); }
...
protected:
     ...
     * Wrapper for templated parameters.
     */
    void _doEstimate(int* params, int param_c, void* model) { doEstimate(params, param_c, (MODEL*) model); }

    /**
     * Wrapper for templated parameters.
     */
    bool _doSupports(int param, void* model) { return doSupports(param, (MODEL*) model); }
...
public:
     ...
     * if a suitable model could not be build at all.
     */
    int estimate(int param_c, int support_limit, int max_rounds, MODEL* model) { return _estimate(param_c, support_limit, max_rounds, model); }
