...
public:
     ...
     * \param weights			Weight vector that can be submitted to give different weights to different measurements. Currently works only with
     * OptimizeMethod::TUKEY_LM.
     */
    double Optimize(CvMat* parameters, CvMat* measurements, double stop, int max_iter, EstimateCallback Estimate, void* param = 0,
            OptimizeMethod method = LEVENBERGMARQUARDT, CvMat* parameters_mask = 0, CvMat* J_mat = 0, CvMat* weights = 0);
};
