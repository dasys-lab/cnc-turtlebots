...
class WrappedMessageHandler
{
  ...
  public:
    ...
    void init(const supplementary::AgentID *id, alica::AlicaEngine* engine)
    {
        ...
        sub1 =
            n.subscribe("/wrapped/move_base_simple/goal", 5, &WrappedMessageHandler::onRosGoalWrapped3037331423, this);
        ...
        pubPoseWithCovarianceStamped_amcl_pose =
            n.advertise<geometry_msgs::PoseWithCovarianceStamped>("/amcl_pose", 5, false);
        pubGoalWrapped_move_base_simple_goal =
            n.advertise<ttb_msgs::GoalWrapped>("/wrapped/move_base_simple/goal", 5, false);
        pubPoseStamped_move_base_simple_goal =
            n.advertise<geometry_msgs::PoseStamped>("/move_base_simple/goal", 5, false);
        pubInitialPoseWrapped_initialpose = n.advertise<ttb_msgs::InitialPoseWrapped>("/wrapped/initialpose", 5, false);
        pubPoseWithCovarianceStamped_initialpose =
            n.advertise<geometry_msgs::PoseWithCovarianceStamped>("/initialpose", 5, false);
