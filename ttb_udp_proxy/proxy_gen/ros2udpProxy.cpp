...
void onRosGoalStatus3667547007(const ros::MessageEvent<actionlib_msgs::GoalStatus>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
...
void onRosGoalID1045734789(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalID::ConstPtr& message = event.getMessage();
	try{
		uint32_t serial_size = ros::serialization::serializationLength(*message);
		buffer = new uint8_t[serial_size+sizeof(uint32_t)];
		ros::serialization::OStream stream(buffer+sizeof(uint32_t), serial_size);
		*((uint32_t*)buffer) = 1045734789u;
		ros::serialization::serialize(stream, *message);
		// write message to UDP
		insocket->send_to(boost::asio::buffer((void*)buffer,serial_size+sizeof(uint32_t)),destEndPoint);
	} catch(std::exception& e) {
...
void onRosGoalStatus1824772280(const ros::MessageEvent<actionlib_msgs::GoalStatus>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalStatus::ConstPtr& message = event.getMessage();
	try{
...
void onRosGoalID3497927358(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalID::ConstPtr& message = event.getMessage();
	try{
...
void onRosGoalStatus1731171973(const ros::MessageEvent<actionlib_msgs::GoalStatus>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalStatus::ConstPtr& message = event.getMessage();
	try{
...
void onRosGoalID3404327051(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalID::ConstPtr& message = event.getMessage();
	try{
...
ros::Publisher pub3667547007;
ros::Publisher pub1045734789;
...
ros::Publisher pub1824772280;
ros::Publisher pub3497927358;
...
ros::Publisher pub1731171973;
ros::Publisher pub3404327051;
...
break; }
case 3667547007ul: {
actionlib_msgs::GoalStatus m3667547007;
ros::serialization::Serializer<actionlib_msgs::GoalStatus>::read(stream, m3667547007);
pub3667547007.publish<actionlib_msgs::GoalStatus>(m3667547007);
break; }
case 1045734789ul: {
actionlib_msgs::GoalID m1045734789;
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m1045734789);
pub1045734789.publish<actionlib_msgs::GoalID>(m1045734789);
break; }
case 979314518ul: {
...
break; }
case 1824772280ul: {
actionlib_msgs::GoalStatus m1824772280;
ros::serialization::Serializer<actionlib_msgs::GoalStatus>::read(stream, m1824772280);
pub1824772280.publish<actionlib_msgs::GoalStatus>(m1824772280);
break; }
case 3497927358ul: {
actionlib_msgs::GoalID m3497927358;
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m3497927358);
pub3497927358.publish<actionlib_msgs::GoalID>(m3497927358);
break; }
case 3940289819ul: {
...
break; }
case 1731171973ul: {
actionlib_msgs::GoalStatus m1731171973;
ros::serialization::Serializer<actionlib_msgs::GoalStatus>::read(stream, m1731171973);
pub1731171973.publish<actionlib_msgs::GoalStatus>(m1731171973);
break; }
case 3404327051ul: {
actionlib_msgs::GoalID m3404327051;
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m3404327051);
pub3404327051.publish<actionlib_msgs::GoalID>(m3404327051);
break; }
...
ros::Subscriber sub12 = n.subscribe("/leonardo/mobile_base/status",5, onRosGoalStatus3667547007,ros::TransportHints().unreliable().tcpNoDelay().reliable());
ros::Subscriber sub13 = n.subscribe("/leonardo/mobile_base/cancel",5, onRosGoalID1045734789,ros::TransportHints().unreliable().tcpNoDelay().reliable());
...
ros::Subscriber sub19 = n.subscribe("/raphael/mobile_base/status",5, onRosGoalStatus1824772280,ros::TransportHints().unreliable().tcpNoDelay().reliable());
ros::Subscriber sub20 = n.subscribe("/raphael/mobile_base/cancel",5, onRosGoalID3497927358,ros::TransportHints().unreliable().tcpNoDelay().reliable());
...
ros::Subscriber sub26 = n.subscribe("/donatello/mobile_base/status",5, onRosGoalStatus1731171973,ros::TransportHints().unreliable().tcpNoDelay().reliable());
ros::Subscriber sub27 = n.subscribe("/donatello/mobile_base/cancel",5, onRosGoalID3404327051,ros::TransportHints().unreliable().tcpNoDelay().reliable());
...
pub3667547007 = n.advertise<actionlib_msgs::GoalStatus>("/leonardo/mobile_base/status",5,false);
pub1045734789 = n.advertise<actionlib_msgs::GoalID>("/leonardo/mobile_base/cancel",5,false);
...
pub1824772280 = n.advertise<actionlib_msgs::GoalStatus>("/raphael/mobile_base/status",5,false);
pub3497927358 = n.advertise<actionlib_msgs::GoalID>("/raphael/mobile_base/cancel",5,false);
...
pub1731171973 = n.advertise<actionlib_msgs::GoalStatus>("/donatello/mobile_base/status",5,false);
pub3404327051 = n.advertise<actionlib_msgs::GoalID>("/donatello/mobile_base/cancel",5,false);
