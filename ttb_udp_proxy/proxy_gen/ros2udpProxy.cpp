...
int main(int argc, char* argv[])
{
    ...
    ros::Subscriber sub4 =
            n.subscribe("/wrapped/move_base_simple/goal", 5, onRosGoalWrapped3867808201, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub5 =
            n.subscribe("/wrapped/initialpose", 5, onRosInitialPoseWrapped1388158846, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ...
    ros::Subscriber sub9 =
            n.subscribe("/leonardo/amcl_pose", 5, onRosPoseWithCovarianceStamped3236539441, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub10 =
            n.subscribe("/leonardo/move_base_simple/goal", 5, onRosPoseStamped674080570, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub11 =
            n.subscribe("/leonardo/initialpose", 5, onRosPoseWithCovarianceStamped491912439, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub12 =
            n.subscribe("/leonardo/mobile_base/sensors/core", 5, onRosSensorState2224094020, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub13 =
            n.subscribe("/leonardo/move_base/NavfnROS/plan", 5, onRosPath1915029401, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ...
    ros::Subscriber sub15 =
            n.subscribe("/raphael/amcl_pose", 5, onRosPoseWithCovarianceStamped3076792854, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub16 =
            n.subscribe("/raphael/move_base_simple/goal", 5, onRosPoseStamped4093078319, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub17 =
            n.subscribe("/raphael/initialpose", 5, onRosPoseWithCovarianceStamped3004550932, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub18 =
            n.subscribe("/raphael/mobile_base/sensors/core", 5, onRosSensorState4286660741, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ...
    ros::Subscriber sub20 =
            n.subscribe("/donatello/visualization_marker", 5, onRosMarker3940289819, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub21 =
            n.subscribe("/donatello/amcl_pose", 5, onRosPoseWithCovarianceStamped736595839, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub22 =
            n.subscribe("/donatello/move_base_simple/goal", 5, onRosPoseStamped2503873000, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub23 =
            n.subscribe("/donatello/initialpose", 5, onRosPoseWithCovarianceStamped2083032085, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub24 =
            n.subscribe("/donatello/mobile_base/sensors/core", 5, onRosSensorState1954641914, ros::TransportHints().unreliable().tcpNoDelay().reliable());
    ros::Subscriber sub25 =
            n.subscribe("/donatello/move_base/NavfnROS/plan", 5, onRosPath1699739415, ros::TransportHints().unreliable().tcpNoDelay().reliable());
