...
void onRosGoalID1068001852(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
...
void onRosGoalID1662742173(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalID::ConstPtr& message = event.getMessage();
	try{
...
void onRosGoalID3621803954(const ros::MessageEvent<actionlib_msgs::GoalID>& event) {
	if(0 == event.getPublisherName().compare(ownRosName)) return;
uint8_t* buffer = NULL;
	const actionlib_msgs::GoalID::ConstPtr& message = event.getMessage();
	try{
...
ros::Publisher pub3689814070;
ros::Publisher pub1068001852;
...
ros::Publisher pub4284554391;
ros::Publisher pub1662742173;
...
ros::Publisher pub1948648876;
ros::Publisher pub3621803954;
...
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m1068001852);
pub1068001852.publish<actionlib_msgs::GoalID>(m1068001852);
break; }
case 979314518ul: {
...
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m1662742173);
pub1662742173.publish<actionlib_msgs::GoalID>(m1662742173);
break; }
case 3940289819ul: {
...
ros::serialization::Serializer<actionlib_msgs::GoalID>::read(stream, m3621803954);
pub3621803954.publish<actionlib_msgs::GoalID>(m3621803954);
break; }
