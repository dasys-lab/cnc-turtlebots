...
namespace alica
{
    ...
    public:
        ...
        /*PROTECTED REGION ID(pub1520438451345) ENABLED START*/ //Add additional public methods here
        /*PROTECTED REGION END*/
    protected:
        virtual void initialiseParameters();
        /*PROTECTED REGION ID(pro1520438451345) ENABLED START*/ //Add additional protected methods here
        /*PROTECTED REGION END*/
    private:
