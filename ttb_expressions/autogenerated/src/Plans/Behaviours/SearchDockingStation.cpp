...
/*PROTECTED REGION ID(inccpp1414681429307) ENABLED START*/
...
namespace alica
{
/*PROTECTED REGION ID(staticVars1414681429307) ENABLED START*/
...
SearchDockingStation::~SearchDockingStation()
{
    /*PROTECTED REGION ID(dcon1414681429307) ENABLED START*/
    // Add additional options here
    /*PROTECTED REGION END*/
}
...
{
    /*PROTECTED REGION ID(initialiseParameters1414681429307) ENABLED START*/
    // Add additional options here
    this->turtleBot->speech->say((*sc)["SpeechAct"]->get<string>("Charging.SearchDockingText", NULL));

    /*PROTECTED REGION END*/
}
/*PROTECTED REGION ID(methods1414681429307) ENABLED START*/
