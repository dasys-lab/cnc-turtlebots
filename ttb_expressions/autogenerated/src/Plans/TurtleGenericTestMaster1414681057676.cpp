...
namespace alicaAutogenerated
{
    ...
    bool TransitionCondition1447068027882::evaluate(shared_ptr<RunningPlan> rp)
    {
    	...
    	if( wm->rawSensorData.getOwnRobotOnOff()->cmd == rqt_robot_control::RobotCommand::START )
    	{
    		return true;
    	}
    ...
    bool TransitionCondition1414681505635::evaluate(shared_ptr<RunningPlan> rp)
    {
    	...
    	if( wm->rawSensorData.getOwnRobotOnOff()->cmd == rqt_robot_control::RobotCommand::STOP )
    	{
    		return true;
    	}
