...
//                && wm->rawSensorData.getOwnRobotOnOff()->cmd == rqt_robot_control::RobotCommand::START)
//        {
//            return true;
//        }
        return false;
    ...
    bool TransitionCondition1414681505635::evaluate(shared_ptr<RunningPlan> rp)
    {
        ...
        if ((wm->rawSensorData.getOwnRobotOnOff() != nullptr)
                && wm->rawSensorData.getOwnRobotOnOff()->cmd == rqt_robot_control::RobotCommand::STOP)
        {
            return true;
        }
    ...
    //State: SearchDockingStation in Plan: TurtleGenericTestMaster
    ...
    //State: Charging in Plan: TurtleGenericTestMaster
    ...
    bool TransitionCondition1447958165046::evaluate(shared_ptr<RunningPlan> rp)
    {
    	...
    	return rp->anyChildrenStatus(PlanStatus::Success) || (wm->rawSensorData.getOwnRobotOnOff() != nullptr
                && wm->rawSensorData.getOwnRobotOnOff()->cmd == rqt_robot_control::RobotCommand::STOP);
        /*PROTECTED REGION END*/
