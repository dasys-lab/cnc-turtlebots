 ...
 */
shared_ptr<UtilityFunction> UtilityFunction1454329729827::getUtilityFunction(
		Plan* plan) {
...
bool TransitionCondition1454329746996::evaluate(shared_ptr<RunningPlan> rp) {
	...
	if ((wm->rawSensorData.getOwnRobotOnOff() != nullptr)
			&& wm->rawSensorData.getOwnRobotOnOff()->cmd
					== robot_control::RobotCommand::START) {
		return true;
	}
	return false;
	/*PROTECTED REGION END*/
...
bool TransitionCondition1454329748126::evaluate(shared_ptr<RunningPlan> rp) {
	...
	if ((wm->rawSensorData.getOwnRobotOnOff() != nullptr)
			&& wm->rawSensorData.getOwnRobotOnOff()->cmd
					== robot_control::RobotCommand::STOP) {
		return true;
	}
	return false;
	/*PROTECTED REGION END*/
