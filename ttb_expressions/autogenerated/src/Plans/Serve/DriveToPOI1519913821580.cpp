...
/*PROTECTED REGION ID(eph1519913821580) ENABLED START*/
...
*
* Plans in State:
*   - Plan - (Name): DriveToPOI, (PlanID): 1454329856163
*
* Tasks:
...
* Vars:
*/
bool PreCondition1519913901102::evaluate(shared_ptr<RunningPlan> rp)
{
...
* Vars:
*/
bool PreCondition1519914093807::evaluate(shared_ptr<RunningPlan> rp)
{
...
* Vars:
*/
bool PreCondition1519914333760::evaluate(shared_ptr<RunningPlan> rp)
{
...
*
* Plans in State:
*   - Plan - (Name): OpenDoor, (PlanID): 1519913953735
*
* Tasks:
*   - DefaultTask (1414681164704) (Entrypoint: 1519913874346)
*
...
* Vars:
*/
bool PreCondition1519913902356::evaluate(shared_ptr<RunningPlan> rp)
{
...
* Vars:
*/
bool PreCondition1519914331734::evaluate(shared_ptr<RunningPlan> rp)
{
