...
/*PROTECTED REGION ID(eph1454332108133) ENABLED START*/
...
* Vars:
*/
bool PreCondition1454332147978::evaluate(shared_ptr<RunningPlan> rp)
{
    /*PROTECTED REGION ID(1454332146639) ENABLED START*/
    return this->checkLastCommand(robot_control::RobotCommand::START);
    /*PROTECTED REGION END*/
}
/*
*
...
*
* Plans in State:
*   - Plan - (Name): Serve, (PlanID): 1454331313621
*
* Tasks:
*   - DefaultTask (1414681164704) (Entrypoint: 1454332108135)
*
...
* Vars:
*/
bool PreCondition1454332144469::evaluate(shared_ptr<RunningPlan> rp)
{
    /*PROTECTED REGION ID(1454332142505) ENABLED START*/
    auto sensorState = this->wm->rawSensorData.getMobileBaseSensorStateBuffer()->getLastValidContent();
    if (sensorState && (*sensorState)->battery < 150)
    {
        return true;
    }
    return false;
...
* Vars:
*/
bool PreCondition1454332146510::evaluate(shared_ptr<RunningPlan> rp)
{
    /*PROTECTED REGION ID(1454332145537) ENABLED START*/
    return this->checkLastCommand(robot_control::RobotCommand::STOP);
    /*PROTECTED REGION END*/
}
/*
*
...
* Vars:
*/
bool PreCondition1454332142376::evaluate(shared_ptr<RunningPlan> rp)
{
...
* Vars:
*/
bool PreCondition1454332145416::evaluate(shared_ptr<RunningPlan> rp)
{
