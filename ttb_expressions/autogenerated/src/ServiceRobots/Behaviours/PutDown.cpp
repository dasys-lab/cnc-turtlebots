...
/*PROTECTED REGION ID(inccpp1553508167181) ENABLED START*/
...
namespace alica
{
/*PROTECTED REGION ID(staticVars1553508167181) ENABLED START*/
...
{
    /*PROTECTED REGION ID(con1553508167181) ENABLED START*/
...
PutDown::~PutDown()
{
    /*PROTECTED REGION ID(dcon1553508167181) ENABLED START*/
    // Add additional options here
    /*PROTECTED REGION END*/
}
void PutDown::run(void* msg)
{
    /*PROTECTED REGION ID(run1553508167181) ENABLED START*/
    result.clear();
...
{
    /*PROTECTED REGION ID(initialiseParameters1553508167181) ENABLED START*/
    this->isPuttingDown = false;
