...
private
class OnRosPointCloud697841562Listener implements MessageListener
{
    @Override public void onNewMessage(Object o)
    {
...
private class OnRosAllocationAuthorityInfo690246385Listener implements MessageListener
{
    @Override public void onNewMessage(Object o)
    {
        ...
        MessageSerializer<AllocationAuthorityInfo> serializer =
                node.getMessageSerializationFactory().newMessageSerializer("alica_ros_proxy/AllocationAuthorityInfo");
        ChannelBuffer buffer = ChannelBuffers.buffer(ByteOrder.LITTLE_ENDIAN, 64000);
        serializer.serialize(converted, buffer);
...
private class OnRosCameraSettingsRequest3170299750Listener implements MessageListener
{
    @Override public void onNewMessage(Object o)
    {
        ...
        MessageSerializer<CameraSettingsRequest> serializer =
                node.getMessageSerializationFactory().newMessageSerializer("msl_sensor_msgs/CameraSettingsRequest");
        ChannelBuffer buffer = ChannelBuffers.buffer(ByteOrder.LITTLE_ENDIAN, 64000);
        serializer.serialize(converted, buffer);
...
private Publisher<PointCloud>
        pub697841562;
private
Publisher<PointCloud> pub715397477;
private
Publisher<PointCloud> pub2242425699;
private
Publisher<VisionDebug> pub4287086446;
private
Publisher<VisionControl> pub3818207232;
private
Publisher<VisionImage> pub520651946;
private
Publisher<KickerStatInfo> pub3915861504;
private
Publisher<MotionStatInfo> pub825806425;
private
Publisher<PassMsg> pub888918809;
private
Publisher<String> pub4022577436;
private
Publisher<RefBoxCommand> pub1841334100;
private
Publisher<JoystickCommand> pub1506505735;
private
Publisher<SharedWorldInfo> pub2791795402;
private
Publisher<PathPlanner> pub709768768;
private
Publisher<VoronoiNetInfo> pub179313306;
private
Publisher<CorridorCheck> pub2924935533;
private
Publisher<PlanTreeInfo> pub3767756765;
private
Publisher<AlicaEngineInfo> pub238666206;
private
Publisher<SyncTalk> pub4175715375;
private
Publisher<SyncReady> pub636345472;
private
Publisher<AllocationAuthorityInfo> pub690246385;
private
Publisher<SolverResult> pub2276189600;
private
Publisher<CameraSettings> pub2163940045;
private
Publisher<CameraSettingsRequest> pub3170299750;
private
Publisher<ProcessCommand> pub3108117629;
private
Publisher<ProcessStats> pub2783514677;
        ...
        try {
            ...
            switch (id) {
                if (id == 697841562l) {
                    ...
                    MessageDeserializer<AllocationAuthorityInfo> deserializer =
                            node.getMessageSerializationFactory().newMessageDeserializer(AllocationAuthorityInfo._TYPE);
                    byte[] message = Arrays.copyOfRange(packet.getData(), Integer.SIZE / Byte.SIZE, packet.getData().length - 4);
                    ...
                    MessageDeserializer<CameraSettingsRequest> deserializer =
                            node.getMessageSerializationFactory().newMessageDeserializer(CameraSettingsRequest._TYPE);
                    byte[] message = Arrays.copyOfRange(packet.getData(), Integer.SIZE / Byte.SIZE, packet.getData().length - 4);
...
int main(int argc, char* argv[])
{
    ...
    final Subscriber sub2 = connectedNode.newSubscriber("/obstacles", "sensor_msgs/PointCloud");
    sub2.addMessageListener(new OnRosPointCloud2242425699Listener());
    final Subscriber sub3 = connectedNode.newSubscriber("/CNVision/VisionDebug", "msl_sensor_msgs/VisionDebug");
    sub3.addMessageListener(new OnRosVisionDebug4287086446Listener());
    final Subscriber sub4 = connectedNode.newSubscriber("/CNVision/VisionControl", "msl_sensor_msgs/VisionControl");
    sub4.addMessageListener(new OnRosVisionControl3818207232Listener());
    final Subscriber sub5 = connectedNode.newSubscriber("/CNVision/VisionImage", "msl_sensor_msgs/VisionImage");
    sub5.addMessageListener(new OnRosVisionImage520651946Listener());
    final Subscriber sub6 = connectedNode.newSubscriber("/KickerStatInfo", "msl_actuator_msgs/KickerStatInfo");
    sub6.addMessageListener(new OnRosKickerStatInfo3915861504Listener());
    final Subscriber sub7 = connectedNode.newSubscriber("/MotionStatInfo", "msl_actuator_msgs/MotionStatInfo");
    sub7.addMessageListener(new OnRosMotionStatInfo825806425Listener());
    final Subscriber sub8 = connectedNode.newSubscriber("/WorldModel/PassMsg", "msl_helper_msgs/PassMsg");
    sub8.addMessageListener(new OnRosPassMsg888918809Listener());
    final Subscriber sub9 = connectedNode.newSubscriber("/mmTalker", "std_msgs/String");
    sub9.addMessageListener(new OnRosString4022577436Listener());
    final Subscriber sub10 = connectedNode.newSubscriber("/RefereeBoxInfoBody", "msl_msgs/RefBoxCommand");
    sub10.addMessageListener(new OnRosRefBoxCommand1841334100Listener());
    final Subscriber sub11 = connectedNode.newSubscriber("/Joystick", "msl_msgs/JoystickCommand");
    sub11.addMessageListener(new OnRosJoystickCommand1506505735Listener());
    final Subscriber sub12 = connectedNode.newSubscriber("/WorldModel/SharedWorldInfo", "msl_sensor_msgs/SharedWorldInfo");
    sub12.addMessageListener(new OnRosSharedWorldInfo2791795402Listener());
    final Subscriber sub13 = connectedNode.newSubscriber("/PathPlanner/PathPlanner", "msl_msgs/PathPlanner");
    sub13.addMessageListener(new OnRosPathPlanner709768768Listener());
    final Subscriber sub14 = connectedNode.newSubscriber("/PathPlanner/VoronoiNet", "msl_msgs/VoronoiNetInfo");
    sub14.addMessageListener(new OnRosVoronoiNetInfo179313306Listener());
    final Subscriber sub15 = connectedNode.newSubscriber("/PathPlanner/CorridorCheck", "msl_msgs/CorridorCheck");
    sub15.addMessageListener(new OnRosCorridorCheck2924935533Listener());
    final Subscriber sub16 = connectedNode.newSubscriber("/AlicaEngine/PlanTreeInfo", "alica_ros_proxy/PlanTreeInfo");
    sub16.addMessageListener(new OnRosPlanTreeInfo3767756765Listener());
    final Subscriber sub17 = connectedNode.newSubscriber("/AlicaEngine/AlicaEngineInfo", "alica_ros_proxy/AlicaEngineInfo");
    sub17.addMessageListener(new OnRosAlicaEngineInfo238666206Listener());
    final Subscriber sub18 = connectedNode.newSubscriber("/AlicaEngine/SyncTalk", "alica_ros_proxy/SyncTalk");
    sub18.addMessageListener(new OnRosSyncTalk4175715375Listener());
    final Subscriber sub19 = connectedNode.newSubscriber("/AlicaEngine/SyncReady", "alica_ros_proxy/SyncReady");
    sub19.addMessageListener(new OnRosSyncReady636345472Listener());
    final Subscriber sub20 = connectedNode.newSubscriber("/AlicaEngine/AllocationAuthorityInfo", "alica_ros_proxy/AllocationAuthorityInfo");
    sub20.addMessageListener(new OnRosAllocationAuthorityInfo690246385Listener());
    final Subscriber sub21 = connectedNode.newSubscriber("/AlicaEngine/SolverResult", "alica_ros_proxy/SolverResult");
    sub21.addMessageListener(new OnRosSolverResult2276189600Listener());
    final Subscriber sub22 = connectedNode.newSubscriber("/CNCalibration/CameraSettings", "msl_sensor_msgs/CameraSettings");
    sub22.addMessageListener(new OnRosCameraSettings2163940045Listener());
    final Subscriber sub23 = connectedNode.newSubscriber("/CNCalibration/CameraSettingsRequest", "msl_sensor_msgs/CameraSettingsRequest");
    sub23.addMessageListener(new OnRosCameraSettingsRequest3170299750Listener());
    final Subscriber sub24 = connectedNode.newSubscriber("/process_manager/ProcessCommand", "process_manager/ProcessCommand");
    sub24.addMessageListener(new OnRosProcessCommand3108117629Listener());
    final Subscriber sub25 = connectedNode.newSubscriber("/process_manager/ProcessStats", "process_manager/ProcessStats");
    sub25.addMessageListener(new OnRosProcessStats2783514677Listener());
