...
\begin{description}
	...
	\item[2. Install Ubuntu - Extra Packages] Simply install the package with the following command: \verb#sudo apt install vim git ssh myrepos capnproto#\\\verb# libcapnp-dev libqt5x11extras5-dev qtscript5-dev liblua5.1.0-dev #\\\verb#bison re2c libcanberra-gtk-module:i386 python-catkin-tools#
