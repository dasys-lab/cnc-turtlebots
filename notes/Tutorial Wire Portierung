...
# And then check-out all our needed packages:
...
package.xml:
add -> <build_depend>cmake_modules</build_depend>
...
Simply replace the old File with the new One attached to this Mail.
