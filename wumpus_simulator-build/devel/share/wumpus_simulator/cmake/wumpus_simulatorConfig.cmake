...
if("TRUE" STREQUAL "TRUE")
  set(wumpus_simulator_SOURCE_PREFIX /home/lab-user/ttbws/src/cnc-turtlebots/wumpus_simulator)
  set(wumpus_simulator_DEVEL_PREFIX /home/lab-user/ttbws/src/cnc-turtlebots/wumpus_simulator-build/devel)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wumpus_simulator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'lab-user <lab-user@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'wumpus_simulator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab-user/ttbws/src/cnc-turtlebots/wumpus_simulator/${idir}'.  Ask the maintainer 'lab-user <lab-user@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lab-user/ttbws/src/cnc-turtlebots/wumpus_simulator-build/devel/lib;/home/lab-user/catkin_ws/devel/lib;/home/lab-user/ttbws/devel/lib;/opt/ros/kinetic/lib)
...
set(wumpus_simulator_EXPORTED_TARGETS "")
